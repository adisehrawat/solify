...
impl AccountOrder {
    ...
    fn get_account_dependencies(
        ...
        for seed in &account.seeds {
            if let crate::analyzer::dependency_analyzer::SeedType::AccountKey = seed.seed_type {
        ...
        for constraint in &account.constraints {
            if let crate::analyzer::dependency_analyzer::ConstraintType::HasOne = constraint.constraint_type {
